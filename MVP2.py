...
# Debugging: Anzeige des aktuellen Schritts
st.write("Aktueller Schritt:", st.session_state.current_step)
...
# Display content for the current tab based on current_step
